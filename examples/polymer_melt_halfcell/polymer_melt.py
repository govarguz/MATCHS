...
rc          = pow(2.0, 1.0/6.0)
maxcutoff   = rc
skin        = float(sys.argv[1])
timestep    = 0.005

halfCellInt = int(sys.argv[2])
...
box = (Lx, Ly, Lz)
system, integrator = espressopp.standard_system.Default(box=box, rc=rc, skin=skin, dt=timestep, temperature=temperature, halfCellInt=halfCellInt)
...
print "total time python ", end_time - start_time
