...
namespace espressopp {
  ...
  public:
    ...
    real maxCutoff;     // maximal cutoff over all of the interactions; computed from interactions
    real expectedMaxCutoff;     // maximal cutoff, that can be provided by user and used to construct DD
