...
namespace espressopp { 
  ...
  DomainDecompositionNonBlocking(shared_ptr< System > _system,
          ...
          boost::python::list& neiListx,
          boost::python::list& neiListy,
          boost::python::list& neiListz)
    : DomainDecomposition(_system, _halfCellInt, _nodeGrid, _cellGrid, neiListx, neiListy, neiListz),
  ...
  void DomainDecompositionNonBlocking::registerPython() {
    ...
    ("storage_DomainDecompositionNonBlocking", init< shared_ptr< System >, int, const Int3D&, const Int3D&, boost::python::list&, boost::python::list&, boost::python::list& >())
    ;
  }
