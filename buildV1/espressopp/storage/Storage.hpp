  ...
  namespace storage {
    ...
    public:
      ...
      */
      ...
      // this is needed in DomainDecompositionDuplicate
      // we want to remove the particles, which are moved to comm layer, but not to trigger signal
      void removeAllParticlesNoSignal();
      ...
      */
      ...
      /// get number of real particles on this node in cells close to boundary
      longint getNRealBoundaryParticles() const;
    ...
    // returns number of ghosts
      ...
      */
      ...
      void getTimeOverheads(real& updateGhosts, real& collectForces, real& decomposeReal, real& exchangeGhosts){
          updateGhosts = timeOverheadUpdateGhosts;
          collectForces = timeOverheadCollectForces;
          decomposeReal = timeOverheadDecomposeReal;
          exchangeGhosts = timeOverheadExchangeGhosts;
      }

      void resetOverheadTimers() {
          timerOverheads.reset();
          timeOverheadUpdateGhosts = 0.0;
          timeOverheadCollectForces = 0.0;
          timeOverheadDecomposeReal = 0.0;
          timeOverheadExchangeGhosts = 0.0;
      }
    ...
    protected:
	 ...
	 for ghosts, which should not overwrite real particle pointers.
      ...
      /** list of such real cells, that are close enought to the boundary to be involved in
       *  communication with some ghost cell. This is used for DomainDecompositionDuplicate, 
       *  since this subset of real cells has to be updated (exchange particles between the 
       *  computation and communication layer
       **/
      CellList realBoundaryCells;
    ...
    private:
      ...
      // used to measure time of overheads in DomainDecompositionDuplicate
      // obviously should not be here, but done for convenience at the moment
      esutil::WallTimer timerOverheads;
      real timeOverheadUpdateGhosts;
      real timeOverheadCollectForces;
      real timeOverheadDecomposeReal;
      real timeOverheadExchangeGhosts;
      ...
      friend class DomainDecompositionDuplicateTemplate;

      friend class DomainDecompositionDuplicate;
    };
  }
}
#endif
