  ...
  namespace storage {
    ...
    protected:
      ...
      */
      ...
      // it is now replicated in DD and here, which is not good
      // should it be moved back to Storage?
      // or, should DD and DDadr be somehow merged, probably one be derived from the other one?
