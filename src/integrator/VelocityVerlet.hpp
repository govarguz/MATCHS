  ...
  namespace integrator {
    ...
    class VelocityVerlet : public MDIntegrator {
      ...
      public:
        ...
        //boost::signals2::signal < void() > saveOldPos;
        //boost::signals2::signal < void() > applyPosConst;
        //boost::signals2::signal < void() > applyVelConst;
      ...
      protected:
        ...
        */
        ...
        real timeInt2;
        real timeResort;
        real timeOverhead; // overhead of the duplicate approach (transfering particles between layers)
