...
namespace espressopp {
  /** A cell is a structure that manages a list of particles and a
      ...
      according to the Linked-Cell-List algorithm (LCL).
      ...
      calculate only half of the interactions (Newton's law: actio =
      ...
      need some ghost-ghost cell interaction as well, which we did not include!
 ...
 #define CELL_EXTRA_DATA

  struct Cell {
#ifdef CELL_EXTRA_DATA
    longint id;
    Int3D grid_pos;
    Real3D myLeft, myRight;
#endif
